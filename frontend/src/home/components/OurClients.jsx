...
export default function OurClients() {
	...
	const fetchCommentaires = async () => {
		try {
			const response = await fetch('https://e-learning-expert-lab-server.onrender.com/commentaires');
	...
	const handleSubmitCommentaire = async (contenu) => {
		try {
			const response = await fetch('https://e-learning-expert-lab-server.onrender.com/commentaire', {
				method: 'POST',
				headers: {
